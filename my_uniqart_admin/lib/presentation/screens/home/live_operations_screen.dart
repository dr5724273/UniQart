            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _infoRow('Buyer', '${buyer?['name'] ?? '-'} ${buyer?['email'] != null ? '(${buyer!['email']})' : ''} ${buyer?['phone'] != null ? '- ${buyer!['phone']}' : ''}'),
                  _infoRow('Lister', '${lister?['name'] ?? '-'} ${lister?['email'] != null ? '(${lister!['email']})' : ''} ${lister?['phone'] != null ? '- ${lister!['phone']}' : ''}'),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 6),
                  _infoRow('Borrower', '${borrower?['name'] ?? '-'} ${borrower?['email'] != null ? '(${borrower!['email']})' : ''} ${borrower?['phone'] != null ? '- ${borrower!['phone']}' : ''}'),
                  _infoRow('Lender', '${lender?['name'] ?? '-'} ${lender?['email'] != null ? '(${lender!['email']})' : ''} ${lender?['phone'] != null ? '- ${lender!['phone']}' : ''}'),
